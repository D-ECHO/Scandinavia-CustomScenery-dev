...
This repository includes the scripts and data that was used for generating the "Scandinavia Custom Scenery". data/SRTM-1 and the work*/ folders are not included for file size reasons, but they can be generated using the scripts given here.
...
To get the finished custom scenery, please see https://github.com/D-ECHO/Scandinavia-CustomScenery
